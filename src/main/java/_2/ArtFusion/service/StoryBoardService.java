...
public class StoryBoardService {
    ...
    public void testForGetAllArchives() {
        ...
        for (int i = 0; i <50; i++) {
            ...
            StoryPost storyPost = new StoryPost("미친 사내가 미치기 전의 평범했던 시절로 돌아간다면. 사내는 다시 미치게 될 것인가? 아니면 사내의 적들이 미치게 될 것인가.광마 이자하, 점소이 시절로 회귀하다.","무협,판타지","이미지 url", user, storyBoard);
            CaptureImage captureImage = new CaptureImage("captureImageUrl", i+1, storyBoard);
